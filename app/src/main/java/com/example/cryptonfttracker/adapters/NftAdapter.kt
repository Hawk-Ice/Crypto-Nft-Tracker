...
class NftAdapter(private val dataSet: List<Nft>) :
...
//        val nftFloorValue: TextView = itemView.findViewById(R.id.nft_floorvalue)
        ...
        val nftDescription : TextView = itemView.findViewById(R.id.nft_desc)
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.nft_list_item, viewGroup, false)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.nftDescription.text = data.description
